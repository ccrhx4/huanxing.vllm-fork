...
python3 benchmark_latency.py --model meta-llama/Meta-Llama-3-8B  --batch-size 1 --input-len 512 --output-len 1024 --max-model-len 4096 --num_iters 5 --repetition-penalty 1.06

echo "running without repetition penalty"
python3 benchmark_latency.py --model meta-llama/Meta-Llama-3-8B  --batch-size 1 --input-len 512 --output-len 1024 --max-model-len 4096 --num_iters 5
