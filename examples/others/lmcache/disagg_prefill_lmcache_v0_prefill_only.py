...
import subprocess
import time
from multiprocessing import Event, Process, set_start_method, get_context
...
def run_prefill(prefill_done, prompts):
    ...
    os.environ["HPU_VISIBLE_DEVICES"] = "0"
...
if __name__ == "__main__":
    ...
    prefill_process = ctx.Process(target=run_prefill, args=(prefill_done, prompts))
    decode_process = ctx.Process(target=run_decode, args=(prefill_done, prompts))
