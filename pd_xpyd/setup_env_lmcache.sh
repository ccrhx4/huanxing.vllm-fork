...
apt update
apt install git wget curl net-tools sudo iputils-ping colorlog -y

echo "2. setting up mooncake mooncake-transfer-engine private build............."
#Mooncake 0.3.7 non-cuda
pip install colorlog mooncake-transfer-engine-non-cuda==0.3.7.post2
