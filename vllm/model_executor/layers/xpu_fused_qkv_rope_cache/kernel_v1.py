...
# Vendored (verbatim kernel body) from ROCm/aiter, commit
# 072403b37b30c78556f6326af3664679dbdc6367:
...
#
# Kernel body is unmodified pure triton.language (no HIP/AMD-specific ops).
# Only the import of the rotation helpers was changed to point at the local
# vendored copy (rope_helpers.py) instead of aiter.ops.triton.rope.rope.
